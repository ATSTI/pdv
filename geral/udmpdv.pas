...
type
  ...
  TdmPdv = class(TDataModule)
    ...
    sqBusca: TSQLQuery;
    sqBusca1: TSQLQuery;
    sqBusca_th: TSQLQuery;
    sqBusca_th1: TSQLQuery;
    ...
    sqLancamentos_thALIQ_CUPOM: TStringField;
    sqLancamentos_thBAIXA: TStringField;
    sqLancamentos_thCEST: TStringField;
    sqLancamentos_thCEST_1: TStringField;
    sqLancamentos_thCFOP: TStringField;
    sqLancamentos_thCODALMOXARIFADO: TLongintField;
    sqLancamentos_thCODCLIENTE: TLongintField;
    sqLancamentos_thCODDETALHE: TLongintField;
    sqLancamentos_thCODIGO: TLongintField;
    sqLancamentos_thCODMOVIMENTO: TLongintField;
    sqLancamentos_thCODNATUREZA: TSmallintField;
    sqLancamentos_thCODPRO: TStringField;
    sqLancamentos_thCODPRODUTO: TLongintField;
    sqLancamentos_thCODUSUARIO: TSmallintField;
    sqLancamentos_thCODVENDEDOR: TSmallintField;
    sqLancamentos_thCOD_BARRA: TStringField;
    sqLancamentos_thCONTROLE: TStringField;
    sqLancamentos_thCONTROLE_1: TSmallintField;
    sqLancamentos_thCORTESIA: TStringField;
    sqLancamentos_thCSOSN: TStringField;
    sqLancamentos_thCST: TStringField;
    sqLancamentos_thCSTCOFINS: TStringField;
    sqLancamentos_thCSTIPI: TStringField;
    sqLancamentos_thCSTPIS: TStringField;
    sqLancamentos_thDATAMOVIMENTO: TDateField;
    sqLancamentos_thDATA_SISTEMA: TDateTimeField;
    sqLancamentos_thDESCONTO: TFloatField;
    sqLancamentos_thDESCONTO_BC: TStringField;
    sqLancamentos_thDESCPRODUTO: TStringField;
    sqLancamentos_thESTOQUEATUAL: TFloatField;
    sqLancamentos_thICMS: TFloatField;
    sqLancamentos_thICMS_SUBST: TFloatField;
    sqLancamentos_thII: TFloatField;
    sqLancamentos_thLOCALIZACAO: TStringField;
    sqLancamentos_thNCM: TStringField;
    sqLancamentos_thNITEMPED: TLongintField;
    sqLancamentos_thNOMECLIENTE: TStringField;
    sqLancamentos_thOBS: TStringField;
    sqLancamentos_thOBS_MD: TStringField;
    sqLancamentos_thOBS_PROD: TStringField;
    sqLancamentos_thORIGEM: TLongintField;
    sqLancamentos_thORIGEM_1: TStringField;
    sqLancamentos_thPCOFINS: TFloatField;
    sqLancamentos_thPIPI: TFloatField;
    sqLancamentos_thPPIS: TFloatField;
    sqLancamentos_thPRECO: TFloatField;
    sqLancamentos_thPRECOATACADO: TFloatField;
    sqLancamentos_thQTDEATACADO: TLongintField;
    sqLancamentos_thQTDE_ALT: TFloatField;
    sqLancamentos_thQUANTIDADE: TFloatField;
    sqLancamentos_thRATEIO: TStringField;
    sqLancamentos_thSTATUS: TSmallintField;
    sqLancamentos_thSTATUS_1: TStringField;
    sqLancamentos_thTIPO: TStringField;
    sqLancamentos_thTIPOPRECOVENDA: TStringField;
    sqLancamentos_thTOTALITEM: TFloatField;
    sqLancamentos_thUN: TStringField;
    sqLancamentos_thUNIDADEMEDIDA: TStringField;
    sqLancamentos_thUSA: TStringField;
    sqLancamentos_thUSUARIOLOGADO: TStringField;
    sqLancamentos_thVALOR_COFINS: TFloatField;
    sqLancamentos_thVALOR_DESCONTO: TFloatField;
    sqLancamentos_thVALOR_ICMS: TFloatField;
    sqLancamentos_thVALOR_OUTROS: TFloatField;
    sqLancamentos_thVALOR_PIS: TFloatField;
    sqLancamentos_thVALOR_SEGURO: TFloatField;
    sqLancamentos_thVALTOTAL: TFloatField;
    sqLancamentos_thVIPI: TFloatField;
    sqLancamentos_thVLRBC_COFINS: TFloatField;
    sqLancamentos_thVLRBC_IPI: TFloatField;
    sqLancamentos_thVLRBC_PIS: TFloatField;
    sqLancamentos_thVLRTOT_TRIB: TFloatField;
    sqLancamentos_thVLR_BASE: TFloatField;
    sqLancamentos_thVLR_BASEICMS: TFloatField;
    SQLQuery1: TSQLQuery;
    sqEmpresa: TSQLQuery;
