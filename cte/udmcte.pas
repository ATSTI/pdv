...
type
  ...
  TdmCte = class(TDataModule)
    ...
    dsQC: TDataSource;
    dsCte: TDataSource;
    sqCompCOD_CTE: TLongintField;
    sqCompCOD_CTE_COMP: TLongintField;
    sqCompCOMP_NOME: TStringField;
    sqCompCOMP_VALOR: TFloatField;
    sqNFeCHAVE: TStringField;
    sqNFeCOD_CTE_NFE: TLongintField;
    sqNFeCTE_NFE: TLongintField;
    sqNFeDPREV: TDateField;
    sqNFePIN: TLongintField;
    sqQCCOD_CTE: TLongintField;
    sqQCCOD_CTE_QC: TLongintField;
